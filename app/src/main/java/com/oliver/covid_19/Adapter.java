...
public class Adapter extends ArrayAdapter<Model> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView total = view.findViewById(R.id.txtViewTotal);
        TextView incactive = view.findViewById(R.id.txtViewActive);
        TextView incurred = view.findViewById(R.id.txtViewCurred);
        TextView incdeath = view.findViewById(R.id.txtViewDeath);
