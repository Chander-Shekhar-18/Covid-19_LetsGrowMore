        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    // Creating JSON Object
                    object3 = object2.getJSONObject("North Delhi");
                    ...
                    model = new Model("North Delhi", confirmed, deceased, recovered, active,
                            confInc, confDec, confRec);
                    // placing data into the app using AdapterClass
                    modelList.add(model);

                    // Creating JSON Object
                    object3 = object2.getJSONObject("North East Delhi");
                    ...
                    model = new Model("North East Delhi", confirmed, deceased, recovered, active,
                            confInc, confDec, confRec);
                    // placing data into the app using AdapterClass
                    modelList.add(model);
                    // Creating JSON Object
                    object3 = object2.getJSONObject("North West Delhi");
                    ...
                    model = new Model("North West Delhi", confirmed, deceased, recovered, active,
                            confInc, confDec, confRec);
                    // placing data into the app using AdapterClass
                    modelList.add(model);

                    object3 = object2.getJSONObject("Shahdara");
                    ...
                    model = new Model("Shahdara", confirmed, deceased, recovered, active,
                            confInc, confDec, confRec);
                    // placing data into the app using AdapterClass
                    modelList.add(model);
                    ...
                    object3 = object2.getJSONObject("South East Delhi");
                    ...
                    model = new Model("South East Delhi", confirmed, deceased, recovered, active,
                            confInc, confDec, confRec);
                    // placing data into the app using AdapterClass
                    modelList.add(model);

                    object3 = object2.getJSONObject("South West Delhi");
                    ...
                    model = new Model("South West Delhi", confirmed, deceased, recovered, active,
                            confInc, confDec, confRec);
                    // placing data into the app using AdapterClass
                    modelList.add(model);
